...
**Discusie en Conclusie: Overwerkte leukocyten door IL6 en verhoogde bescherming door BCL2A1 als gevolg** 


In de resultaten waren veel genen bij RA-patiënten statistisch als biologisch significant betrokken bij een verhoogde of verlaagde genregulatie, vergeleken met een patiënt zonder RA. In de algemene RA-pathway map en apoptose-pathway map van KEGG.jp, waren significante, expressionele verhogingen (3x) bij IL6 (Interleukine 6) en BCL2A1 gevonden, die betrokken zijn bij de gevormde overwerking van leukocyten en het voorkomen van celdood bij RA-patiënten. IL6 geeft door citrullinisatie veel overwerkende functies door aan T-en B-cellen, waardoor ontsteking wordt versterkt. Hiervoor bestaat al een veilig-geteste DMARD voor, die in meer dan honderd landen beschikbaar is.  BCL2A1 staat bekend als een regulator van apoptose, door zijn regulerende functie toe te passen op de situatie (Bij te veel celdood bijvoorbeeld) ([Vogler, 2012](Bronnen/BCL2A1%3A%20the%20underdog%20in%20the%20BCL2%20family%20-%20DOI)). Hierdoor kan met de verkregen data geconcludeerd probeert te minimaliseren.   Hierop kan verder volgens de resultaten geconcludeerd worden dat geamplificeerde bescherming door het overwerkend immuunsysteem een sterk gevolg is van RA. Volgens ([Yoshida & Tanaka, 2014](Bronnen/Interleukin%206%20and%20Rheumatoid%20Arthritis.pdf)) is er al veel bekend over de hoofdrolspelers bij de vorming van RA. 
